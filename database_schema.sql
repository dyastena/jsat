...
-- RPC function to get leaderboard data efficiently
-- Replace the old function with corrected column names
...
BEGIN
    ...
    WITH level_data AS (
        SELECT
            l.Profile_id,  -- FIXED: Use Profile_id for level table
            l.Progress,
            l.Level_status,
    ...
    user_stats AS (
        SELECT
            e.Profile_id,  -- FIXED: Use profile_id for evaluation table
